...
echo -e "threshold\tMean/MultiLabel-F0.5\tMean/MultiLabel-F2\tF0.5\tF2\tAccFstError\tAccAnyError\talpha" | tee -a results_baseline_mean_probability.tmp
...
echo -e "$result" | tee -a results_baseline_mean_probability.tmp
